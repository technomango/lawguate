...
class AddCaseEmailToLawyerToEmailTemplates extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $email_template = \Modules\Setting\Model\EmailTemplate::withOutGlobalScope(\App\Scopes\OrganizationScope::class)->where('type', 'case_email_to_lawyer')->first();
        if ($email_template){
            return;
        }
        DB::table('email_templates')->insert([
            [
                'name' => 'Case Email To Lawyer',
                'type' => 'case_email_to_lawyer',
                'subject' => 'Appointed as a lawyer',
                'module' => 'EmailtoCL',
                'value' => <<<'EOD'
                                ...
                                <table cellpadding="0" cellspacing="0" style="table-layout:fixed;vertical-align:top;border-spacing:0;border-collapse:collapse;" width="100%">
                                    ...
                                    <tr style="vertical-align:top;" valign="top">
                                        <td align="center" style="vertical-align:top;padding-bottom:5px;padding-left:0px;padding-right:0px;padding-top:25px;text-align:center;width:100%;" valign="top" width="100%">
                                            <h1 style="color: rgb(85, 85, 85); font-family: Arial, " helvetica="" neue",="" helvetica,="" sans-serif;="" font-size:="" 36px;="" letter-spacing:="" normal;="" line-height:="" 120%;="" text-align:="" center;="" margin-top:="" 0px;="" margin-bottom:="" 0px;"="">Appointed as a lawyer</h1>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
...
EOD
                ,
                'available_variable' => '{LAWYER_NAME}, {CASE_TITLE}, {APP_NAME}, {CASE_CATEGORY}, {CASE_NO}, {CASE_FILE_NO}, {CASE_ACTS}, {PLAINTIFF}, {ACCUESED}, {ON_BEHALF_OF}, {COURT}, {REFERENCE_NAME}, {REFERENCE_MOBILE}, {LAWYER}, {CASE_STAGE}, {CASE_CHARGE}, {RECEIVING_DATE}, {FILING_DATE}, {HEARING_DATE}, {JUDGEMENT_DATE}',
                'status' => true
            ],
    ...
    {
        \Modules\Setting\Model\EmailTemplate::where('type', 'case_email_to_lawyer')->delete();
    }
}
