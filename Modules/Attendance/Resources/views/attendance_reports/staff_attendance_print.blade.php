      ...
      <div class="container-fluid">
         <table  cellspacing="0" width="100%">
            <tr>
                ...
                <td>
                  <img class="logo-img" src="{{asset(config('configs.site_logo'))}}" alt="">
               </td>
               <td>
                  <h3 style="font-size:22px !important" class="text-white"> {{config('configs.site_title')}} </h3>
                  <p style="font-size:18px !important" class="text-white mb-0"> {{ config('configs.address') }} </p>
               </td>
