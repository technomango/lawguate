    ...
    <div class="main-title mb-25">
        <h3 class="mb-0">{{ __('setting.SMTP Settings') }} <span class="badge_1"> {{ (config('configs.mail_protocol') == "smtp") ? 'SMPT' : 'PHP Mail' }}  </span></h3>
    </div>
            ...
            <div class="col-xl-12">
                <div class="primary_input">
                    ...
                    <select class="primary_select mb-25" name="mail_protocol" onchange="smtp_form()" id="mail_mailer">
                        <option value="smtp"@if (config('configs.mail_protocol') == "smtp") selected @endif>SMTP</option>
                        <option value="sendmail"@if (config('configs.mail_protocol') == "sendmail") selected @endif>PHP Mail</option>
                    </select>
                </div>
            </div>
        </div>
