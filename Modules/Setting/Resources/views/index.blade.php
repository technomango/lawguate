                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <div class="white_box_30px mb_30">
                                    <ul class="nav custom_nav" id="myTab" role="tablist">
                                        ...
                                        @if((permissionCheck('cron.index') && !moduleStatusCheck('AdvSaas')) || auth()->user()->is_saas_admin)
                                            <li class="nav-item">
                                        ...
                                        @endif
                                        @if(permissionCheck('case.layout'))
                                        <li class="nav-item">
                                            <a class="nav-link" id="caseLayout-tab" data-toggle="tab" href="#caseLayout"
                                            role="tab" aria-controls="contact"
                                            aria-selected="false">{{ __('setting.Case Layout') }}</a>
                                        </li>
                                    @endif
                                        ...
                                        @if(permissionCheck('email_template_settings.index') and $email_templates)
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="tab-content " id="myTabContent">
                                    ...
                                    @if(permissionCheck('case.layout'))
                                    <!-- case layout  -->
                                        <div class="tab-pane fade white_box_30px" id="caseLayout" role="tabpanel"
                                             aria-labelledby="caseLayout-tab">
                                            @include('setting::page_components.case_layout')
                                        </div>
                                        <!-- case layout -->
                                    @endif
                                    @if(permissionCheck('login_bg_image.index'))
...
@push('js_after')
    <script type="text/javascript">
        ...
        _formValidation2('update_layout_setting');
