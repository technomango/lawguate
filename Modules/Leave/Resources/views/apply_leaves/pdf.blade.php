...
<head>
    ...
    <title>{{ config('configs.company_name') }}</title>
...
<div class="invoice_heading">
    <div class="invoice_logo">
        <img src="{{ config('configs.site_logo') ?? asset('public/uploads/settings/logo.png') }}" width="100px" alt="">
    </div>
    ...
    <div class="invoice_logo">
        <table class="table-borderless">
            <tr>
                ...
                <td><b>:</b></td>
                <td>{{ config('configs.company_name') }}</td>
            </tr>
            <tr>
                <td><b>{{__('common.Phone')}}</b></td>
                <td><b>:</b></td>
                <td><a href="tel:{{ config('configs.phone')}}">{{config('configs.phone')}}</a></td>
            </tr>
            <tr>
                <td><b>{{__('common.Email')}}</b></td>
                <td><b>:</b></td>
                <td><a href="mailto:{{ config('configs.email')}}">{{config('configs.email')}}</a>
                </td>
            </tr>
            <tr>
                <td><b>{{__('payroll.Address')}}</b></td>
                <td><b>:</b></td>
                <td><a href="">{{ config('configs.address')}}</a></td>
            </tr>
        </table>
    </div>
    <div class="invoice_logo">
