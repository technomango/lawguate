            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="primary_input col-md-6">
                        ...
                        {{Form::select('category', $category, $model->case_category_id, ['required' => '', 'class' => 'primary_select', 'data-placeholder' => __('client.Select Category'), 'data-parsley-errors-container' => '#category_error'])}}
