...
<div class="single-report-admit">
    <div class="card-header">
        <h2 class="text-center text-uppercase color-whitesmoke" >{{ __('service::install.license_verification') }} | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a>
        </h2>
