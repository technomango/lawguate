                                ...
                                <div class="add-visitor">
                                    <table style="width:100%; box-shadow: none;"
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ config('configs.system_version') }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ config('configs.system_domain') }}</td>
                                        </tr>


                                        <tr>
                                            <td>{{__('setting.System Activated Date')}}</td>
                                            <td>{{ dateFormat(config('configs.system_activated_date')) }}</td>
                                        </tr>
                                        <tr>
                                            <td>{{__('setting.Last Update')}}</td>
                                            <td>{{ dateFormat(config('configs.last_updated_date')) }}</td>
                                        </tr>
