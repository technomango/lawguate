...
@section('title',app('general_setting')->site_title.' | Blog Single')
@section('breadcrumb','Blog')
@section('styles')
    <link rel="stylesheet" href="{{asset(asset_path('frontend/default/css/blog.css'))}}">
...
@section('content')
    ...
    <section class="blog_part bg-white padding_top mb-30">
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <div class="blog_details_part">
                        <div class="blog_details_img">
                            ...
                            @else
                                <img src="{{showImage('public/frontend/default_image/blog.jpg')}}" alt="">
                            @endif
                        ...
                        <div class="blog_details_content">
                            ...
                            <div class="author_details">
                                <div class="author_img">
                                    <img src="{{isset($post->user->avatar)?showImage($post->user->avatar) : showImage(isPathPublic().'backend/img/avatar.png')}}" alt="#">
                                </div>
                            ...
                            <div class="comment_area">
                                ...
                                <div class="comment_area_iner">
                                    @foreach($post->comments as $comment)
                                        <div class="media">
                                            <a href="#">
                                                <img src="{{isset($comment->commentUser->avatar)?showImage($comment->commentUser->avatar):showImage(isPathPublic().'backend/img/avatar.png')}}" alt="...">
                                            </a>
                                            <div class="media-body">
                                                ...
                                                @auth
                                                    <div class="d-flex">
                                                        <a  class="btn_2 reply d-flex mr-10" cid="{{ $comment->id }}" post_id="{{ $post->id }}" token="{{ csrf_token() }}">Reply</a>
                                                        @if(auth()->user()->role->type == 'superadmin' || auth()->user()->role->type == 'admin')
                                                        <a  class="btn_2 delete_comment d-flex" data-link="{{route('blog.comment.delete',$comment->id)}}">Delete</a>
                                                        @endif
                                                    </div>
    ...
    @include('frontend.default.partials._delete_modal',['item_name' => __('comment')])
@endsection
@push('scripts')
