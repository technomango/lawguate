<div class="modal-dialog  modal-dialog-centered modal-{{ $modal ?? 'lg' }}">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">{{ __('client.New Company Category') }}</h4>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-12">
                    {!! Form::open(['route' => 'category.company.store', 'class' => 'form-validate-jquery', 'id' => 'client_category_quick_add_form', 'files' => false, 'method' => 'POST']) !!}
