@extends('layouts.master', ['title' => __('client.Update Company Category')])
            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{__('client.Update Company Category')}}</h3>
                    </div>
                </div>
            </div>
                <div class="col-12">
                    <div class="white_box_50px box_shadow_white">
                        ...
                        {!! Form::model($model, ['route' => ['category.company.update', $model->id], 'class' =>
                        ...
                        <div class="primary_input">
                            ...
                            __('client.Company Category Description'), 'rows' => 5 ])}}
                        </div>
